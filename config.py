...
INTERNAL_GAME_AREA_WIDTH_TILES = 40 # This will be dynamically calculated
...
MIN_GAME_AREA_TILES_WIDTH = 20  # Ensure at least 20 tiles wide are always shown
...
TARGET_EFFECTIVE_TILE_SCALE = 2 # <--- ADD THIS LINE
