...
STRUCTURE_BLUEPRINTS = {
    ...
    "small_cabin": build_blueprint(
        ...
        {"#": wall, "w": window, "*": tavern_cobweb, "p": wood_plank, ".": tavern_floor, "V": tavern_floor, "c": tavern_floor, "+": door, "b": bed, "t": table, "s": shelf},
        walkable_chars={".", "V", "c", "+"},
    ...
    "watch_tower": build_blueprint(
        ...
        {"#": wall, "w": window, ".": tavern_floor, "l": ladder, "+": door, "b": bed, "t": table, "*": tavern_cobweb, "p": wood_plank, "c": tavern_crate, "b": tavern_barrel, "=": bar_counter},
        walkable_chars={".", "c", "+"},
    ...
    "shop": build_blueprint(
        ...
        {"#": wall, "w": window, ".": tavern_floor, "b": tavern_barrel, "c": tavern_crate, "S": tavern_floor, "+": door, "s": shelf, "t": shelf_two, "=": bar_counter},
        walkable_chars={".", "S", "+"},
        description="A traveling merchant's storefront.",
        npc_map={"S": _spawn_shopkeeper},
    ),
    ...
    "tavern": build_blueprint(
        ...
        {
            "#": wall, "w": window, ".": tavern_floor, "j": tavern_floor, "*": tavern_cobweb, "s": shelf, "h": shelf_two, "o": tavern_floor, "r": tavern_floor, "c": tavern_crate, 
            "p": tavern_floor, "A": tavern_floor, "k": tavern_barrel_two, "I": bar_counter_two, "|": bar_counter_three, "7": bar_counter_four, "t": table, "+": door
        },
